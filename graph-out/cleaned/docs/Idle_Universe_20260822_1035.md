---
title: Idle Universe
original_filename: Idle_Universe_20260822_1035
date: 2026-08-22
time: 10:35
...
- **首次发布**: 2017
- **价格**: Free
- **评分**: 4.25826/5 (1514 评价)
- **版本号**: v1.423
- **一句话描述**: Create your own universe in this new addictive idle game!

First, you have to gather matter yourself by tapping; but once you've got enough matter to create a couple of objects in your universe, these will produce more matter automatically by colliding

## 玩法规则

Create your own universe in this new addictive idle game!

First, you have to gather matter yourself by tapping; but once you've got enough matter to create a couple of objects in your universe, these will produce more matter automatically by colliding.

Features:
• Create many different interstella
