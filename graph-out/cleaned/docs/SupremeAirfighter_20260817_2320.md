---
title: Supreme Airfighter
original_filename: SupremeAirfighter_20260817_2320
date: 2026-08-17
time: 23:20
source: gameplay-library
---

# 终极空战士（Supreme Airfighter）

- **类型**: 射击
- **平台**: Mobile (Java)
- **开发商**: 未知
- **首次发布**: 2010
- **一句话描述**: Personally, I can never get enough scrolling vertical shoot-'em-ups. Even though it's a very limited genre that piqued in 1985, put me in a slow moving plane or spaceship and pit m
...
选择战机自动射击 → 收集power-ups → 击败波次敌人推进关卡

## 核心机制

- 自动射击+手动power-up管理：自动开火但需要策略性收集和使用武器
- 智能自动开火：没有敌人时不浪费弹药，出现敌人时自动射击
- 垂直卷轴射击：经典竖版射击玩法
- Power-up队列：后获得的武器优先使用，依次回退到基础武器

## 为什么好玩

在泛滥的竖版射击游戏中，智能自动开火机制是一个独特的创新。自动在无敌人和有敌人之间切换，既保证了流畅体验又不会浪费弹药，是射击游戏爱好者的小惊喜。

## 粘性来源

对射击游戏爱好者来说，通关所有关卡和收集所有power-up是主要目标。智能开火机制让每局游戏节奏紧凑，"再试一次就能打更远"的心态驱动重复游玩。

## Meta 系统

战机选择和power-up收集，不同战机有不同的基础属性。

## 实现难度

低 — 竖版射击是成熟的游戏类型，技术实现相对简单。主要难点在于敌机AI、弹幕模式和power-up系统的平衡设计。

## 来源

- 抓取 URL: https://www.pocketgamer.com/supreme-airfighter/review/
- 评测来源: Pocket Gamer