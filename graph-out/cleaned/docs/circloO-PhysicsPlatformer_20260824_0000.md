...
original_filename: circloO-PhysicsPlatformer_20260824_0000
date: 2026-08-24
time: 00:00
...
- **首次发布**: 2022
- **一句话描述**: circloO is a colorful physics platformer in a growing circle. This app version contains all…
...
You're a small ball rolling around in a round level. Collect circles to grow the level circle. As it grows, everything stays in the level, so you'll have to avoid and use obstacles in everchanging ways. For example, a platform that was first very useful t
