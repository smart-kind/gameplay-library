...
original_filename: GoEscape-CasualBallGames_20260824_0000
date: 2026-08-24
time: 00:00
...
- **开发商**: AI Games FZ
- **首次发布**: 2018
- **一句话描述**: Go Escape is a wickedly addictive mobile game that amps up the classic ball game…

## 玩法规则

Go Escape is a wickedly addictive mobile game that amps up the classic ball game vibe with a killer twist. You're not just rolling a ball here: you're mastering the art of precision and strategy. The whole game is a mind-bending journey of making that epic ball jump, bounce, and dodge its way from one rad platform to the next, with each level cranking up the heat.

The star of the show? It's a ball that's not just any old sphere. This thing is sleek, responsive, and handles like a dream. Thanks 
...
- https://apps.apple.com/us/app/go-escape-casual-ball-games/id1435951901?uo=4