...
original_filename: 15PuzzleChallenge_20260826_2040
date: 2026-08-26
time: 20:40
...
- **开发商**: Forsbit LLC
- **首次发布**: 2011
- **一句话描述**: Do you think you are smart enough??? Then try and win in the ultimate 15 Puzzle Challenge! Become the ONLY master of the
...
15 Puzzle Challenge is offering you great chance to refresh your skills in the well-known puzzle game. All of us used to play it once…but everything has changed since then. With 15 Puzzle Challenge yo

## 核心机制

- **游戏类型**: Games — Games, Puzzle, Family
- **操作方式**: 触摸/点击/滑动交互
- **评分系统**: 平均评分4.67126（1378次评价）
- **当前版本**: 3.0.9
...
- iTunes Search API: https://itunes.apple.com/search?term=15%20Puzzle%20Challenge.&media=software
- App Store: https://apps.apple.com/us/app/15-puzzle-challenge/id416789249?uo=4