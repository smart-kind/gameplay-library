...
original_filename: ShadowgunLegends_20260813_0117
date: 2026-08-13
time: 01:17
...
- **开发商**: Deca Games EOOD
- **首次发布**: 2018
- **一句话描述**: Experience an epic story campaign, competitive and cooperative multiplayer, and an innovative social hub, all in one game!

In the futuristic world of Shadowgun Legends, humanity is under attack from a deadly alien invader

## 玩法规则

在 Shadowgun Legends 中，玩家操控角色在一个充满敌人和障碍的环境中进行战斗。游戏采用直观的触屏操作：
...
Shadowgun Legends 的好玩之处在于其流畅的战斗手感和丰富的角色多样性。每次成功躲避攻击并反击的瞬间都带来极大的成就感。游戏将动作游戏的爽快感与策略思考相结合。
...
- iTunes: Shadowgun Legends: Online FPS