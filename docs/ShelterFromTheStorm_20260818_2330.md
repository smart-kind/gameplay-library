# Shelter from the Storm's hilarious charm rekindled my love for the humble point-and-click

- **类型**: 点击冒险
- **平台**: Mobile
- **开发商**: 待确认
- **首次发布**: 待确认
- **一句话描述**: There were no quality-of-life features then, no easy way to return to an earlier save point if you managed to fail spect
...
- https://www.pocketgamer.com/shelter-from-the-storm/review/