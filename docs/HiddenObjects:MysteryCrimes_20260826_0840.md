...
- **价格**: Free
- **用户评分**: 4.31/5 (6175 评价)
- **一句话描述**: Step into the shoes of a private detective and solve puzzling cases in this brand-new FREE hidden ob...
...
根据开发者描述：Step into the shoes of a private detective and solve puzzling cases in this brand-new FREE hidden object game! Hunt down clues and expose the hidden motives of criminals the cops can’t catch.
...
• ENHANCE your case by hacking computers, dus
...
- iTunes API: https://apps.apple.com/us/app/hidden-objects-mystery-crimes/id674105088?uo=4
