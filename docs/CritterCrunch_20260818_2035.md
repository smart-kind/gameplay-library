...
- **首次发布**: 2008
- **PocketGamer 评分**: 8/10
- **一句话描述**: But not for everyone. Take Biggs, for example. He's a round orange fella who lives in the jungle, spending his time gobbling up cute critters hanging ...
...
- **机制1**: As you work your way through, you'll start to encounter power-ups, or 'Power Foods' as they're known here. Pop a sparkling critter, and you get a power food, which turns into an icon at the bottom lef

- **机制2**: There's much more to discover too, with new elements constantly being added to keep you on your toes: Toxic Creatures, Bombers, Blockers and Wild Cards.

- **机制3**: Mode-wise, there's the regular Adventure mode, but also a Puzzle variant, where you have to clear the screen of all critters within a certain number of moves. It's brain-taxing in a different way. Mea

## 为什么好玩

Okay, so you've twigged that this isn't a natural history lesson, and Biggs doesn't actually exist in the real world. It's the plot of Critter Crunch, one of Pocket Gamer's favourite ever mobile games

## 粘性来源

It certainly deserves a wider audience than it got on mobile. The iPhone version follows the same formula, introducing you to the game's various elements over the first few levels. Essentially, it's t
...
- https://www.pocketgamer.com/critter-crunch-iphone/review/
