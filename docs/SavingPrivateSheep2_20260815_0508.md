...
- **开发商**: (待确认)
- **首次发布**: 2012-04-27
- **PocketGamer评分**: 8/10 (Reviewer: Jon Denton)
- **一句话描述**: But it only takes one level of Saving Private Sheep 2 to make all those concerns slip away. While it certainly owes a de
...
玩家需要The setup is simple. You play as an army of sheep who use catapults to fire hedg → 获得进度/评分 → 解锁更多内容
...
But it only takes one level of Saving Private Sheep 2 to make all those concerns slip away. While it
...
- https://www.pocketgamer.com/saving-private-sheep-2/review/
...
Reach for the stars As is the norm in iOS gaming these days, you can get three stars in each level by hoovering up the coins - and indeed the star - in each map.