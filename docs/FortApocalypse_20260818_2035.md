...
- **首次发布**: 2008
- **PocketGamer 评分**: 8/10
- **一句话描述**: Fortunately, my phobia doesn't extend to virtual choppers - obviously. Fortunate because, if it did, I wouldn't be playing Fort Apocalypse. And not pl...
...
- **机制1**: So you've hopefully got a fair idea of what Fort Apocalypse is (those of you who missed the 1982 Atari original), which is essentially a very retro shooter, but one that's exceptionally pretty - espec

- **机制2**: But while it might be the sort of game you've played plenty of times before, Fort Apocalypse stands out because it's a real adrenaline-charged roller-coaster of a shooter. It begins gently but builds 

- **机制3**: It controls well, there's a ton of action and the two types of helicopter, not to mention your various different missions, mix things up a lot. And for real retro fans there's an original version of t
...
- https://www.pocketgamer.com/fort-apocalypse/review/
