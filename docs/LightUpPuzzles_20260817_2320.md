# 点亮谜题（LightUp Puzzles）

- **类型**: 益智
- **平台**: Mobile (iOS)
- **开发商**: 未知
- **首次发布**: 2010
- **一句话描述**: As any watcher of terrible Romantic films knows, constellations are a perfect way to a lady’s heart. What can say ‘I’m a tender soul’ better than tracing out abstract shapes in the
...
在迷宫中绘制光路 → 点亮所有方块不重复 → 完成星座图案进入下一关

## 核心机制

- 蛇形光路：类似贪吃蛇的玩法，在迷宫中绘制路径
- 不可重复：不能经过已访问过的方块，类似一笔画
- 星座主题：以绘制星座图案为主题，浪漫轻松的氛围
- 音乐氛围：精心配乐帮助营造游戏体验

## 为什么好玩

将贪吃蛇式的走迷宫玩法包装成星座绘制，清新浪漫。精心设计的音乐和视觉风格让这款游戏在益智类中脱颖而出，每一关都有恰到好处的挑战感。

## 粘性来源

完成星座图案的收集欲望和"差一点就能完成"的不甘是主要粘性。每关的音乐和视觉反馈提供了正向激励，让玩家想要点亮所有星座。

## Meta 系统

星座收集图鉴，完成一幅星座图案后解锁下一幅，有明确的收集目标。

## 实现难度

低 — 核心是网格寻路算法，技术实现相对简单。难点在于关卡设计的趣味性和难度曲线把控，以及音乐与画面的同步效果。

## 来源

- 抓取 URL: https://www.pocketgamer.com/lightup-puzzles/review/
- 评测来源: Pocket Gamer