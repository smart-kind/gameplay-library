...
- **评分**: Pocket Gamer 评分 6/10
- **机制1**: Anyone who sampled last year's Dynamite Fishing will know that throwing in a few explosives can make the world of differ...
- **机制2**: HandyGames's follow-up is barely distinguishable from its predecessor. This is a title where the fundamentals of play - ...
- **机制3**: Set in the arena of an international dynamite fishing contest, you move from round to round, trying to reach a points ta...
- **机制4**: Viewed from the side on, you guide your boat left or right (via keys '4' and '6') on top of the water with a clear view ...
...
- 抓取 URL: https://www.pocketgamer.com/dynamite-fishing-2/review/
