...
- **机制1**: There are five mini-golfers, four of whom you unlock by completing their respective courses. As wannabe mini-golf star M...
- **机制2**: Instead of going purely by the number of strokes you take, your score on each hole is a factor of strokes taken, golden ...
- **机制3**: Points are awarded or subtracted from the skill gauge running along the top of the screen. You begin each hole with a ma...
- **机制4**: Fabulously designed holes ensure a fun challenge. Ramps and oddly-placed walls make estimating of your ball's trajectory...
...
- 抓取 URL: https://www.pocketgamer.com/mini-golf-theme-park-99-holes-smart-phone/review/
