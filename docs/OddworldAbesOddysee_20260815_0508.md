...
- **开发商**: (待确认)
- **首次发布**: 2012-04-26
- **PocketGamer评分**: 9/10 (Reviewer: Damien  McFerran)
- **一句话描述**: The central character is Abe, a Mudokon slave who toils endlessly inside a sinister meat production plant called Rupture
...
玩家需要To this end, they will happily drive entire species to extinction - and early on → 获得进度/评分 → 解锁更多内容

## 核心机制

- 机制1：触屏操控：通过触摸屏直接控制角色或环境，提供直观的交互体验
- 机制2：潜行系统：玩家需要在不被发现的情况下完成任务，利用阴影和环境掩护
- 机制3：精神控制：特殊能力允许玩家控制敌人，将劣势转化为优势

## 为什么好玩

PocketGamer给出9/10高分，说明游戏在解谜类型中表现突出。
The central character is Abe, a Mudokon slave who toils endlessly inside a sinister meat production 
...
- https://www.pocketgamer.com/oddworld-abes-oddysee/review/
